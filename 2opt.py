...
def two_opt(cities,threshold):
    ...
    factor = 1 # Initialize the improvement factor.

    best_distance = path_distance(route,cities) # Calculate the distance of the initial path.

    while factor > threshold: # If the route is still improving, keep going!
        ...
        factor = 1 - best_distance/distance_to_beat # Calculate how much the route has improved.
